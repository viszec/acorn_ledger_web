...
export default function Plans() {
  ...
  return (
    <section
      id="plans"
      className="section-wrapper lg:pt-28 pt-16 lg:pb-36 pb-16 bg-gray-50"
    >
      <motion.div
      ...
      >
        ...
        <motion.div className="text-center mb-12" variants={cardVariants}>
          <h2 className="lg:text-4xl text-2xl font-bold mb-4">
            Finding Our Plans and Pricing
          </h2>
          <p className="lg:text-lg text-sm text-gray-600 ">
            Get all features of Acorn Ledger, Start your financial management
            journey.
          </p>
          ...
          <div className="mt-8 inline-flex items-center bg-gray-200 rounded-lg p-1">
            <button
              className={`px-4 lg:py-2 py-1 lg:text-sm text-xs rounded-lg ${
            ...
            <button
              className={`px-4 lg:py-2 py-1 lg:text-sm text-xs rounded-lg flex items-center gap-2 ${
                isAnnual ? "bg-white shadow" : ""
              }`}
              onClick={() => setIsAnnual(true)}
            >
              Annually
              <span className="lg:text-xs text-xxs px-2 py-1 bg-gray-50 text-purple-600 rounded">
                Popular
              </span>
            </button>
          </div>
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`bg-white rounded-2xl p-8 ${
                plan.isPopular
                  ? "border-2 border-purple-400 ring-1 ring-purple-400"
